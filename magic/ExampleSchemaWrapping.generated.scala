object ExampleSchemaWrapping {
  ...
  case class WholeExampleSchemaWrapping(graph: raw.Graph) extends Graph {
    ...
    def relations: (Seq[_$12] forSome { 
      type _$12 <: (Relation[_$9, _$6] forSome { 
        type _$9;
        type _$6
      })
    }) = Seq.empty.++(eats);
    def abstractRelations: (Seq[_$3] forSome { 
      type _$3 <: (AbstractRelation[_$8, _$5] forSome { 
        type _$8;
        type _$5
      })
    }) = Seq.empty.++(eats);
    def hyperRelations: (Seq[_$2] forSome { 
      type _$2 <: (HyperRelation[_$7, _$4, _$1, _$11, _$10] forSome { 
        type _$7;
        type _$4;
        type _$1;
        type _$11;
